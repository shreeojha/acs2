...
// send url to reset password through phpmailer
        ...
        $mail->Username = 'shreeojha89@outlook.com';
                  $mail->Password = 'F@ceb00k9';

                  $mail->setFrom('shreeojha89@outlook.com', 'OTP Verification');
        // get email from input
        $mail->addAddress($_POST["email"]);
        //$mail->addReplyTo('acs@gmail.com');
